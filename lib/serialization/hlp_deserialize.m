...
%fprintf('pos=%12d->%12d m(pos)=%3d class=%-s\n',oldpos,pos,m(oldpos),class(v));
end
...
pos = pos + 1;
% Get contents
[props,pos] = deserialize_value(m,pos); 
% construct object
v=table();
...
pos = pos + 1;
% Get categories
[cats,pos] = deserialize_value(m,pos);
% Get codes
